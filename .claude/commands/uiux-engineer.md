---
description: Professional UI/UX engineering workflow — implement UI changes, redesign components, add interactions, fix visual bugs, improve accessibility. Always validates with tests and build.
---
